...
DockerSandbox.prototype.execute = function(success)
{
    ...
    var outputCMD = this.output_command || '\"\"';

    //this statement is what is executed
    var runBotFilename = 'runBot.js';
    var st = this.path+'DockerTimeout.sh ' + this.timeout_value + 's -u mysql -e \'NODE_PATH=/usr/local/lib/node_modules\' -i -t -v  "' + this.path + this.folder + '":/usercode ' + this.vm_name + ' /usercode/script.sh ' + this.compiler_name + ' ' + runBotFilename + ' ' + outputCMD+ ' ' + this.extra_arguments;
